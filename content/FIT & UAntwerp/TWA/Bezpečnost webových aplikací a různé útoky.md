...
útok - je skutečná akce, že někdo přijde a provede útok (využívá zranitelnosti k poškození zdrojů)
zranitelnost - chyba v aplikaci, která je předpokladem pro hrozbu

Hrozby:
- nešifrovaná komunikace, krádež hesel a citlivých údajů
- nehashování/nesolení hesel uložených v DB
